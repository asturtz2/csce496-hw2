...
def main(argv):
	# load train data
	train_data_name = ['train_x_1.npy','train_x_2.npy','train_x_3.npy','train_x_4.npy']
	train_data_label = ['train_y_1.npy','train_y_2.npy','train_y_3.npy','train_y_4.npy']
	# load test data
	...
	for i in range(test_images_name):
		# load train data
		print('The data set number {} is utilized',format(i))
		train_images = np.load(FLAGS.data_dir + train_data_name[i])
		train_labels = np.load(FLAGS.data_dir + train_data_label[i]
		# load test data
